    ...
    return (
        <>
            ...
            <div className="flex flex-wrap items-center gap-x-10 gap-y-2 m-5 p-10 border-2 border-orange-700 bg-gray-100">
                ...
                {/* 3 :: Molecules */}
                <div className="bg-white p-5">
                    <CardNumWP cardAmountVal='3,600,180.22' subPercent='88'></CardNumWP>
                </div>
                ...
                <div className="bg-white p-5">
                    <SumTitleValue subTitle='Raised'
                        cardAmountVal='12.6' unit='Cr'>
                    </SumTitleValue>
                </div>

                {/* 5.2 :: Molecules */}
                <div className="bg-white p-5">
                    <SumTitleValue subTitle='Repaid' cardAmountVal='3,600,180.22' subPercent='12'>
                    </SumTitleValue>
                </div>
                ...
                {/* 9 :: Molecules */}
                <RoundCard roundNo='1' roundDate='16 May ‘23' roundRsTotal='65' roundRsUnit='Lakh' outStandingRs='787,689' rePaidRs='143,544' status='active'>
                </RoundCard>
